...
import 'package:potta_pos/src/shared/components/gap.dart';
...
class Input extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color borderColor = context.colorScheme.onPrimaryContainer;
      ...
      children: [
        if (labelText != null) ...[
          Text(
            ...
            style:
                labelStyle ??
                Theme.of(context).textTheme.bodySmall?.copyWith(fontWeight: FontWeight.w600, color: labelColor, fontSize: 14.sp),
          ),
