...
class ContactDetailsBottomSheet extends StatefulWidget {
  const ContactDetailsBottomSheet({super.key});

  @override
  State<ContactDetailsBottomSheet> createState() => _ContactDetailsBottomSheetState();
}

class _ContactDetailsBottomSheetState extends State<ContactDetailsBottomSheet> {
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(
                    I18n.of(context).add_contact_details,
              ...
              Input(
                ...
                hintText: I18n.of(context).phone_detail,
              ...
              Input(
                ...
                labelText: I18n.of(context).phone_mobile,
                hintText: I18n.of(context).mobile_detail,
                cursorColor: context.colorScheme.primary,
                fillColor: context.colorScheme.primary.withOpacity(0.05),
                style: Theme.of(context).primaryTextTheme.bodyLarge?.copyWith(color: context.colorScheme.shadow),
                textCapitalization: TextCapitalization.none,
              ...
              Input(
                ...
                labelText: I18n.of(context).email_mobile,
                hintText: I18n.of(context).email_detail,
                cursorColor: context.colorScheme.primary,
                fillColor: context.colorScheme.primary.withOpacity(0.05),
                style: Theme.of(context).primaryTextTheme.bodyLarge?.copyWith(color: context.colorScheme.shadow),
                textCapitalization: TextCapitalization.none,
              ...
              Input(
                ...
                labelText: I18n.of(context).website_mobile,
                hintText: I18n.of(context).website_detail,
                cursorColor: context.colorScheme.primary,
                fillColor: context.colorScheme.primary.withOpacity(0.05),
                style: Theme.of(context).primaryTextTheme.bodyLarge?.copyWith(color: context.colorScheme.shadow),
                textCapitalization: TextCapitalization.none,
